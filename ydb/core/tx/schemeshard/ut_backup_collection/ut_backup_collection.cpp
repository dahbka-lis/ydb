...
Y_UNIT_TEST_SUITE(TBackupCollectionTests) {
    ...
    Y_UNIT_TEST(IncrementalRestoreScanStatusToRetriable) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(static_cast<int>(MapScanStatus(EStatus::Done)),
            static_cast<int>(TProgress::END_SUCCESS));
        UNIT_ASSERT(!ShouldRetryIncrementalRestore(TProgress::END_SUCCESS));
        ...
        UNIT_ASSERT_VALUES_EQUAL(static_cast<int>(MapScanStatus(EStatus::Term)),
            static_cast<int>(TProgress::END_TRANSIENT_FAILURE));
        UNIT_ASSERT(ShouldRetryIncrementalRestore(TProgress::END_TRANSIENT_FAILURE));
        ...
        UNIT_ASSERT_VALUES_EQUAL(static_cast<int>(MapScanStatus(EStatus::Lost)),
            static_cast<int>(TProgress::END_FATAL_FAILURE));
        ...
        UNIT_ASSERT_VALUES_EQUAL(static_cast<int>(MapScanStatus(EStatus::Exception)),
            static_cast<int>(TProgress::END_FATAL_FAILURE));
        UNIT_ASSERT(!ShouldRetryIncrementalRestore(TProgress::END_FATAL_FAILURE));

        // END_UNSPECIFIED: safe default, treat as fatal (no retry).
        UNIT_ASSERT(!ShouldRetryIncrementalRestore(TProgress::END_UNSPECIFIED));
    }
